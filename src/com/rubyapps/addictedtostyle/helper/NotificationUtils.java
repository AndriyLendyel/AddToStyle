...
public class NotificationUtils {
	...
	public void showNotificationMessage(String title, String message,
		...
		/*
		 * } else { intent.putExtra("title", title); intent.putExtra("message",
		 * message); intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK |
		 * Intent.FLAG_ACTIVITY_SINGLE_TOP); mContext.startActivity(intent); }
		 */
	}
